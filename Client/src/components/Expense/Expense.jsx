    ...
    <div className="min-h-screen ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="backdrop-blur-lg bg-white/30 rounded-3xl shadow-xl p-8 border border-white/50">
          <h2 className="text-3xl font-bold text-gray-800/90 mb-8">Add New Expense</h2>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end">
              <button className="inline-flex w-full flex justify-center sm:w-auto items-center px-8 py-3 backdrop-blur-sm bg-red-600/80 hover:bg-red-700/100 
